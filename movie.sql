...
INSERT INTO `collection` (`id`, `user_id`, `review_id`, `create_time`) VALUES
(0, 'douya330', 0, '2019-2-15 18:18:20'),
(1, 'llxl1009', 1, '2019-2-16 16:16:40');
...
CREATE TABLE `movie_review` (
  ...
  `movie_image` varchar(511) NOT NULL,
  `user_id` varchar(255) NOT NULL,
  `user_name` varchar(255) DEFAULT NULL,
  `user_avatar` varchar(255) NOT NULL,
  `type` varchar(10) NOT NULL,
  `duration` int(11) DEFAULT NULL,
  `movie_review` varchar(511) CHARACTER SET utf8 DEFAULT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `movie_review` (`id`,`movie_id`, `movie_title`, `user_id`, `movie_image`, `user_name`, `user_avatar`,`type`, `duration`, `movie_review`,`create_time`) VALUES
(0, 13, '机器人总动员','https://movie-list-1258311047.cos.ap-shanghai.myqcloud.com/p1461851991.jpg','douya330', '豆芽猫', 'https://test-1258311047.cos.ap-shanghai.myqcloud.com/timg.jpeg', 0, 0, '安卓和苹果的爱情故事', '2019-02-15 20:59:41'),
(1, 14, '死亡诗社','https://movie-list-1258311047.cos.ap-shanghai.myqcloud.com/p1910824340.jpg','llxl1009', '罹生', 'https://test-1258311047.cos.ap-shanghai.myqcloud.com/mdd01.png', 0, 0, '人生是一场漫长的绝望', '2019-02-16 20:59:41');
...
SET @IMAGE_BASE_URL = "https://movie-list-1258311047.cos.ap-shanghai.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
...
ALTER TABLE `collection`
  MODIFY `id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, AUTO_INCREMENT=4;
--
